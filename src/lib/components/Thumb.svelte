<div style="margin-top: {positionY}px; margin-left: {positionX}px" class="w-full h-full">
    <div class="rounded-md bg-slate-100 border p-2 w-16 hover:bg-slate-50 cursor-pointer flex flex-row" on:click={clicked}>
        <span class="text-l {clickCount < 5 && clickCount !== 0 ? 'text-red-500' : 'text-blue-500'} mr-2">{likeCount}</span>
        <svg class="fill-blue-500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" width="20px" height="20px" viewBox="0 0 47 47" xml:space="preserve">
            <g>
                <g id="Layer_1_27_">
                    <g>
